...
namespace EU_Calculator
{
    public partial class Form1 : Form
    {
        ...
        private void CountVotes(string votet)
        {
            VoteCal voteCalculator = new VoteCal(votet);//Creates a new voting calculator
        ...
        private void Unamity_Click(object sender, EventArgs e)
        {
            CountVotes("UN");//Calculates the result with the selected data type
        }

        private void QM_Click(object sender, EventArgs e)
        {
            CountVotes("QM");//Calculates the result with the selected data type
        }
